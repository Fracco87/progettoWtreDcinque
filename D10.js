...
function dice() {
  ...
  */
  function deleteOne(string1, isTrue) {
    let string1 = "colore";
    let isTrue = true;
    if (string1.length === 5) {
      string1.slice(0)
    ...
    */
    function onlyletters(string1) {
      let string1 = "i have 4 dogs"
      let string2 = string1.replace(8)
    }
    console.log(string2)
    ...
    */
    function isThisAnEmail(eMail) {
      let questaEmailValida = arsenio.lupin@gmail;
      return questaEmailValida.test(eMail);
    }
